...
import { Layout, Menu, Card, Select } from 'antd';
...
function App() {
  ...
  const [selectedPainterId, setSelectedPainterId] = useState<string>('painter-1');
    ...
    return (
      <Layout style={{ minHeight: '100vh', backgroundColor: '#f0f2f5' }}>
        ...
        <Content style={{ 
          ...
          >
            <FormatPainterFilled style={{ fontSize: '48px', color: '#1890ff', marginBottom: '16px' }} />
            <h2>I'm a Painter</h2>
    ...
    <Layout style={{ minHeight: '100vh' }}>
      <Header style={{ display: 'flex', alignItems: 'center', backgroundColor: '#1890ff' }}>
        <h1 style={{ color: 'white', margin: 0, flex: 1 }}>
          🎨 Adam Painter Booking - {userType === 'painter' ? `${selectedPainterId} Dashboard` : 'Customer Portal'}
        </h1>
        <Menu
          theme="dark"
          mode="horizontal"
